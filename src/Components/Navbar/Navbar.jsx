...
class Navbar extends Component {
  ...
  render() {
    const sideList = (
      <div className="list_width">
        <ul className="collection with-header">
          <li className="collection-header blue darken-3">
            <h6 className="white-text">
              {this.props.User ? (this.props.User.email) : (null)}
            </h6>
          </li>
          {this.props.status === "Admin" ? (<li className="collection-item">
            <NavLink to="/" className="blue-text">Requests</NavLink>
          </li>) : (null)}
          {this.props.status === "Company" ? (<li className="collection-item">
            <NavLink to="/" className="blue-text">Students</NavLink>
          </li>) : (null)}
          {this.props.status === "Student" ? (<li className="collection-item">
            <NavLink to="/" className="blue-text">Vacancies</NavLink>
          </li>) : (null)}
          {this.props.status === "Admin" ? (<li className="collection-item">
            <NavLink to="/Students" className="blue-text">Students</NavLink>
          </li>) : (null)}
          {this.props.status === "Admin" ? (<li className="collection-item">
            <NavLink to="/Vacancies" className="blue-text">Vacancies</NavLink>
          </li>) : (null)}
          {this.props.status === "Admin" || this.props.status === "Student" ? (<li className="collection-item">
            <NavLink to="/Companies" className="blue-text">Companies</NavLink>
          </li>) : (null)}
          {this.props.status === "Company" ? (<li className="collection-item">
            <NavLink to="/PostVacancy" className="blue-text">Post New Vacancy</NavLink>
          </li>) : (null)}
          {this.props.status === "Company" || this.props.status === "Student" ? (<li className="collection-item">
            <NavLink to="/Profile" className="blue-text">Profile</NavLink>
          </li>) : (null)}
          <li className="collection-item">
            <NavLink to="/SignOut" className="blue-text">Sign Out</NavLink>
          </li>
        </ul>
      </div>
    );
    return (
      <div>
        {this.props.User ? (<Fragment><nav className="nav-wrapper blue darken-4">
          <div className="container">
            ...
            &nbsp;
            &nbsp;
        <span className="flow-text blue darken-4 hide-on-large-only">Campus Recruitment System</span>
