                ...
                {this.state.show ? (<div>
                        ...
                        <div className="col s12 l7 offset-l3">
                            <div className="card">
                                <ul className="collection with-header myCollections">
                                    <li className="collection-header"><b className="blue-text">Student Requests</b></li>
                                    {this.props.AllSrequests.length > 0 ? (this.props.AllSrequests.map(v => <li key={v.userId} className="collection-item myCollections">
                                        ...
                                        <button className="btn-small btn-floating waves-effect waves-light transparent secondary-content" >
                                            <i className="material-icons blue-text text-darken-3" onClick={() => { this.props.RequestSCancel(v.urid) }}>highlight_off</i>
                                        </button>
                                        <span className="secondary-content">&nbsp; &nbsp;</span>
                                        <button className="btn-small btn-floating waves-effect waves-light transparent secondary-content" >
                                            <i className="material-icons blue-text text-darken-3" onClick={() => { this.props.RequestSAccept(v.editId, v.urid) }}>check_circle_outline</i>
                                        </button>
                                        <span className="secondary-content">&nbsp; &nbsp;</span>
                                        <button className="btn-small btn-floating waves-effect waves-light transparent secondary-content" >
                                            <i className="material-icons blue-text text-darken-3" onClick={() => { this.dS(v.userId) }}>info</i>
                                        </button>
                    ...
                    <div className="row">
                        <div className="col s12 l7 offset-l3">
                            <div className="card">
                                <ul className="collection with-header myCollections">
                                    <li className="collection-header"><b className="blue-text">Companies Requests</b></li>
                                    {this.props.AllCrequests.length > 0 ? (this.props.AllCrequests.map(v => <li key={v.userId} className="collection-item myCollections">
                                        ...
                                        <button className="btn-small btn-floating waves-effect waves-light transparent secondary-content" >
                                            <i className="material-icons blue-text text-darken-3" onClick={() => { this.props.RequestCCancel(v.urid) }}>highlight_off</i>
                                        </button>
                                        <span className="secondary-content">&nbsp; &nbsp;</span>
                                        <button className="btn-small btn-floating waves-effect waves-light transparent secondary-content" >
                                            <i className="material-icons blue-text text-darken-3" onClick={() => { this.props.RequestCAccept(v.editId, v.urid) }}>check_circle_outline</i>
                                        </button>
                                        <span className="secondary-content">&nbsp; &nbsp;</span>
                                        <button className="btn-small btn-floating waves-effect waves-light transparent secondary-content" >
                                            <i className="material-icons blue-text text-darken-3" onClick={() => { this.dC(v.userId) }}>info</i>
                                        </button>
                                    </li>)) : (<div className="center grey-text flow-text">No Requests.</div>)}
                                    <li className="collection-item myCollections"></li>
                                </ul>
