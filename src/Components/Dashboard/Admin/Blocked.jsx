...
const Blocked = (props) => {
    return (
        <div className="container">
            ...
            <br />
            <br />
            <div className="blue lighten-4 center">
                ...
                <br />
                <br />
                <button className="btn-small waves-effect waves-light blue" onClick={() => {props.logOut(); props.goBack();}}>Go Back To SignUp/SignIn</button>
                <br />
                <br />
            </div>
        </div>
