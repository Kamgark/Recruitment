    ...
    return (<Fragment>
        <div className="container hide-on-small-only"> <br /> <br /> {props.user ? (props.status === "Admin" ? (props.allVacancies.length > 0 ? (<div className="row">
            <div className="col l12 s12 m12">
                <table><thead className="blue darken-1 z-depth-1">
            ...
            <h5 className="blue-text text-darken-1">No Company has posted any vacancy yet!</h5>
                        ...
                        {props.unBlockedVacanies.map((v, i) => {
                            return (
                                <tr key={v.postId}>
                                    ...
                                    {/*  <td>
                                            <span className="btn-floating waves-effect waves-light blue" onClick={() => {}}>
        ...
        <div className="row">
            <div className="col l12 s12 m12">
                <table className="smallFont"><thead className="blue darken-1 z-depth-1">
                    <tr className="white-text">
                        ...
                        {props.allVacancies.map((v, i) => {
                            return (
                                <Fragment key={v.postId}>
                                    ...
                                    <tr>
                                        <td colSpan="2" className="blue lighten-4"></td>
                                    </tr>
                                </Fragment>)
                        })}
                    </tbody>
            ...
            <h6 className="blue-text text-darken-1">No, Company has posted any vacancy yet!</h6>
        </div>)) : (props.unBlockedVacanies.length > 0 ? (<div className="row">
            <div className="col l12 s12 m12">
                <table className="smallFont"><thead className="blue darken-1 z-depth-1">
                    <tr className="white-text">
                        ...
                        {props.unBlockedVacanies.map((v, i) => {
                            return (
                                <Fragment key={v.postId}>
                                    ...
                                    <tr>
                                        <th colSpan="2" className="blue lighten-4">
                                            {/* <span className="waves-effect waves-light right btn-small blue darken-1" onClick={() => { }}>
                                                Apply Now
                                            </span> */}
                                        </th>
                                    </tr>
