        ...
        return (
            <Fragment>
                {this.props.currentUser ? (
                    <Fragment>
                        {this.state.edit ? (null) : (<nav className="nav-wrapper blue darken-4">
                        ...
                        <div className="container">
                            <br />
                            <div className="row">
                                <div className="blue  col l12 s12 darken-1 white-text center flow-text">
                                ...
                                <form onSubmit={this.onAdd}>
                                    <div className="blue col l12 s12 lighten-5">
                                        <br />
                                    </div>
                                    <div className="blue col l12 s12 lighten-5">
                                    ...
                                    {this.state.edit ? (null) : (<div className="blue col l12 s12 lighten-5">
                                    ...
                                    <div className="col s4 l2 offset-s4 offset-l5 ">
                                        {this.state.edit ? (
                                            <Button cn="btn-large waves-effect waves-light  blue darken-1" t="Update Request" />
                                        ) : (
                                            <Button cn="btn-large waves-effect waves-light blue darken-1" t="Register" />)}
                                    </div>
                                    <br />
                                    <br />
                                </form>
