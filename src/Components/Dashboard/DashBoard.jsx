            ...
            <Fragment>
                {this.state.dashboard ? (<div className="mainPage">
                    ...
                    <div className="container white">
                        <h2 className="blue-text text-darken-4 center mainHeading hide-on-med-and-down">
                            Welcome to WYKA Recruitment System
                        </h2>
                        <h6 className="blue-text text-darken-4 center mainHeading hide-on-large-only">
                            Welcome to WYKA Recruitment System
                        </h6>
                        ...
                        <div className="row">
                            <div className="col s6 l6 m6 offset-l5 offset-s3 offset-m4">
                                <ul>
                                    <li className="form_a blue-text text-lighten-1" onClick={() => {this.showS("Student")}}>
                                        <h4>Student</h4>

                                    </li>
                                    <li className="form_a blue-text text-lighten-1" onClick={() => {this.showS("Company")}}>
                                        <h4>Company</h4>

                                    </li>
                                    <li className="flow-text form_a blue-text text-lighten-1" onClick={() => {this.showS("Admin")}}>
                                        <h4>Admin</h4>
                                    </li>
                                </ul>
                            </div>
                ...
                <Fragment>
                    ...
                    <div className="container">
                        <span className="brand-logo hide-on-small-only">WYKA Recruitment System</span>
                        <span className="hide-on-med-and-up">WYKA Recruitment System</span>
                    </div>
                </nav>
                    <br/>
                    <div className="container">
