                    ...
                    <div className="col s12 m8 l6 offset-l3 offset-m2">
                        <div className="card blue lighten-5">
                            <div className="card-image">
                                ...
                                {props.isDisabledS ? (<span className="btn-floating halfway-fab waves-effect waves-light grey lighten-2"><i className="material-icons">add</i></span>) : (<span className="btn-floating halfway-fab waves-effect waves-light blue lighten-2" onClick={() => { props.history.push("/Registration") }}><i className="material-icons">add</i></span>)}
                            </div>
                ...
                <div className="col l4 s12 offset-l1">
                    <div className="card">
                        <div className="card-image">
                            ...
                            {props.isDisabledC ? (
                                <span className="btn-floating halfway-fab waves-effect waves-light grey lighten-2"><i className="material-icons">add</i></span>) : (<span className="btn-floating halfway-fab waves-effect waves-light blue lighten-2" onClick={() => { props.history.push("/CompanyInfo") }}><i className="material-icons">add</i></span>)}
                        </div>
                        <div className="card-content">
                            <div className="card-title blue-text">
                                ...
                                <table className="hide-on-small-only">
                                    ...
                                    <tbody>
                                        {currentCompanyVacancies.map(v => <tr key={v.postId}>
                                            ...
                                            <td>{v.salary}</td>
                                            <td>{v.ec}</td>
                                            <td><span className="btn-floating btn-small waves-effect waves-light blue lighten-2" onClick={() => { props.deleteVacancy(v.postId) }}><i className="material-icons">cancel</i></span></td>
                                        </tr>)}
                                    </tbody>
                                </table>
                                ...
                                <table className="smallFont hide-on-med-and-up">
                                    <tbody>
                                        {currentCompanyVacancies.map(v =><Fragment key={v.postId}>
                                            ...
                                            <tr>
                                                <td colSpan="2"><span className="btn-small waves-effect waves-light blue lighten-2 right" onClick={() => { props.deleteVacancy(v.postId) }}>Delete</span></td>
                                            </tr>
                                            </Fragment>)}
                                    </tbody>
                                </table>
